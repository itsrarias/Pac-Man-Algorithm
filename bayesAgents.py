...
def constructBayesNet(gameState):
    ...
    varList = [X_POS_VAR, Y_POS_VAR] + HOUSE_VARS + obsVars
    net = bn.constructEmptyBayesNet(varList, edges, variableDomainsDict)
    return net, obsVars
...
def fillYCPT(bayesNet, gameState):
    ...
    topLeft = {Y_POS_VAR: LEFT_TOP_VAL}
    topRight = {Y_POS_VAR: BOTH_TOP_VAL}
    bottomLeft = {Y_POS_VAR: LEFT_BOTTOM_VAL}
    bottomRight = {Y_POS_VAR: BOTH_BOTTOM_VAL}

    yFactor.setProbability(topRight, PROB_BOTH_TOP)
    yFactor.setProbability(topLeft , PROB_ONLY_LEFT_TOP)
    yFactor.setProbability(bottomRight, PROB_BOTH_BOTTOM)
    yFactor.setProbability(bottomLeft, PROB_ONLY_LEFT_BOTTOM)
